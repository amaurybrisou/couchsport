...
func (me pageHandler) ProfilePages(userID uint, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Error(err)
		http.Error(w, api_errors.ErrNotFound.Error(), http.StatusUnprocessableEntity)
		return
	}
...
func (me pageHandler) New(userID uint, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		log.Error(err)
		http.Error(w, api_errors.ErrCouldNotCreate.Error(), http.StatusBadRequest)
		return
	}
...
func (me pageHandler) Delete(userID uint, w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		http.Error(w, api_errors.ErrCouldNotDelete.Error(), http.StatusBadRequest)
		return
	}
